...
def quad_eval(coef: NDArray[numpy.floating], center: Tuple[float, ...] | NDArray[numpy.floating]) -> float: ...
def pencil(p: NDArray[numpy.floating], q: NDArray[numpy.floating], mu: float) -> NDArray[numpy.floating]: ...
...
def _pdist_tangency_parallel(ellcloud: EllipseCloud, n_jobs: int | None = -1) -> NDArray[numpy.floating]: ...
